...
import fr.unice.polytech.hcs.flows.data.*;
import fr.unice.polytech.hcs.flows.utils.*;
...
import static fr.unice.polytech.hcs.flows.utils.Endpoints.CSV_INPUT_FILE_CITIZENS;
